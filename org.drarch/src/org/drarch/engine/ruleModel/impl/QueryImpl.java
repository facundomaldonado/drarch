 ...
 * </copyright>
 *
 * $Id: QueryImpl.java,v 1.1 2006/10/07 19:08:21 nfrontini Exp $
 */
...
public class QueryImpl extends EObjectImpl implements Query {
	...
	public void setQueryString(String newQueryString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RuleModelPackage.QUERY__QUERY_STRING, oldQueryString, queryString));
	}
