...
import org.drarch.diagram.trace.LogQueryFactory;
import org.drarch.diagram.trace.LogSearcher;
...
public class LogFacts {
	...
	public LogFacts(QueryEngine theQueryEngine, KnowledgeBase theKnowledgeBase, Phase thePhase) {
	...
	public LogFacts(QueryEngine theQueryEngine, KnowledgeBase theKnowledgeBase, TraceLog theLog, Phase thePhase) {
		log = theLog;
		searcher = new LogSearcher(log);
		factsList = new ArrayList<String>();
		knowledgeBase = theKnowledgeBase;
