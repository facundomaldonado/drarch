 ...
 * <copyright> </copyright>
 * 
 * $Id: EStringToLogNodeMapEntryImpl.java,v 1.1 2006/10/07 19:05:16 nfrontini
 * Exp $
 */
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>EString To Log Node Map Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class EStringToLogNodeMapEntryImpl extends EObjectImpl implements
    BasicEMap.Entry {
  /**
  ...
  public void setTypedKey(String newKey) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          LogModelPackage.ESTRING_TO_LOG_NODE_MAP_ENTRY__KEY, oldKey, key));
  }
      ...
      if (value != oldValue) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              LogModelPackage.ESTRING_TO_LOG_NODE_MAP_ENTRY__VALUE, oldValue,
              value));
      }
    }
    return value;
  ...
  public void setTypedValue(LogNode newValue) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          LogModelPackage.ESTRING_TO_LOG_NODE_MAP_ENTRY__VALUE, oldValue, value));
  }
  ...
  public EMap getEMap() {
    ...
    return container == null ? null : (EMap) container
