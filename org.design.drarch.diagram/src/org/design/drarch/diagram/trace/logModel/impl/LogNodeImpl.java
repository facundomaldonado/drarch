...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Log Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class LogNodeImpl extends EObjectImpl implements LogNode {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogModelPackage.LOG_NODE__NAME, oldName, name));
	}
