...
public class ResponsibilityImpl extends EObjectImpl implements Responsibility {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogModelPackage.RESPONSIBILITY__NAME, oldName, name));
	}
	...
	public EList getExecutions() {
		if (executions == null) {
			executions = new EObjectResolvingEList(InnerTag.class, this, LogModelPackage.RESPONSIBILITY__EXECUTIONS);
		}
		return executions;
	}
