...
public class UCMDiagramImpl extends EObjectImpl implements UCMDiagram {
		...
		if (model != null && model.eIsProxy()) {
			...
			if (model != oldModel) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UcmModelPackage.UCM_DIAGRAM__MODEL, oldModel, model));
			}
		}
		return model;
	}
	...
	public void setModel(UCMModel newModel) {
		...
		model = newModel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmModelPackage.UCM_DIAGRAM__MODEL, oldModel, model));
	}
