...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UCM Model</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class UCMModelImpl extends EObjectImpl implements UCMModel {
	...
	/**
	 * The cached value of the '{@link #getComponentRoles() <em>Component Roles</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmModelPackage.UCM_MODEL__NAME, oldName, name));
	}
	...
	public EList getPaths() {
		if (paths == null) {
			paths = new EObjectResolvingEList(Path.class, this, UcmModelPackage.UCM_MODEL__PATHS);
		}
		return paths;
	}
	...
	public EList getComponentRoles() {
		if (componentRoles == null) {
			componentRoles = new EObjectResolvingEList(ComponentRole.class, this, UcmModelPackage.UCM_MODEL__COMPONENT_ROLES);
		}
