...
import org.drarch.diagram.DiagramModel.ucmModel.impl.UcmModelFactoryImpl;
...
public interface UcmModelFactory extends EFactory {
   ...
   * @generated
   */
  UcmModelFactoryImpl eINSTANCE = new UcmModelFactoryImpl();
  ...
  /**
   * Returns a new object of class '<em>Path Node</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
  ...
  /**
   * Returns a new object of class '<em>UCM Model</em>'. <!-- begin-user-doc
   * --> <!-- end-user-doc -->
   * 
