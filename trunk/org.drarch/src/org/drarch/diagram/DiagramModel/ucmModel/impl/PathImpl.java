...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Path</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class PathImpl extends EObjectImpl implements Path {
  ...
  /**
   * The cached value of the '{@link #getStartNodes() <em>Start Nodes</em>}'
  ...
  /**
   * The cached value of the '{@link #getEndNodes() <em>End Nodes</em>}'
   * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
   * 
   * @see #getEndNodes()
   * @generated
  ...
  public EList getNodes() {
    if (nodes == null) {
      nodes = new EObjectWithInverseResolvingEList(PathNode.class, this,
          UcmModelPackage.PATH__NODES, UcmModelPackage.PATH_NODE__PATH);
    }
    return nodes;
  }
  ...
  public EList getStartNodes() {
    if (startNodes == null) {
      startNodes = new EObjectResolvingEList(PathNode.class, this,
          UcmModelPackage.PATH__START_NODES);
    }
    return startNodes;
  }
  ...
  public EList getEndNodes() {
    if (endNodes == null) {
      endNodes = new EObjectResolvingEList(PathNode.class, this,
          UcmModelPackage.PATH__END_NODES);
    }
    return endNodes;
  }
