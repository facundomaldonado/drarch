...
public class SuggestTreeLabelProvider extends LabelProvider implements
    ITableLabelProvider {
  ...
  public void init() {
    ...
    Image check = Activator.getImageDescriptor(CHECKED_IMAGE + ".gif")
        .createImage();
    Image uncheck = Activator.getImageDescriptor(UNCHECKED_IMAGE + ".gif")
        .createImage();
  ...
  public Image getColumnImage(Object element, int columnIndex) {
    return (columnIndex == 0) ? // COMPLETED_COLUMN?
        getImage(((TreeObject) element).isSelected()) : null;
  }
}
