...
public class ExecuteStepAction extends Action {
	 ...
	 * @param currentPhase 
     */
    private void buildViewTree(TreeParent viewCurrentNode, DrarchInteractivePhase currentPhase) {
    	...
    	if(nodeValue instanceof DrarchInteractivePhase) {
    		Step currentStep = ((DrarchInteractivePhase)nodeValue).getCurrentStep();
