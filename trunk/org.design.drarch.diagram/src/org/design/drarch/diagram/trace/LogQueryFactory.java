...
public class LogQueryFactory {
  ...
  public static final String DEFAULT_RESPONSIBILITY_QUERY = 
    "logResponsibility(?R)";
  public static final String DEFAULT_EXECUTION_QUERY = 
    "responsibilityExecution(?R,?I)";
  public static final String DEFAULT_METHOD_QUERY = 
    "executionMethod(?I,?M)";
  public static final String DEFAULT_CLASS_QUERY = 
    "executionDeclaredClass(?I,?C)";
  public static final String DEFAULT_COMPONENT_CLASS_ASSOCIATION_QUERY = 
    "association(?C,?P,?CU),component(?C)";
  public static final String DEFAULT_COMPONENT_RESPONSIBILITY_ASSOCIATION_QUERY 
