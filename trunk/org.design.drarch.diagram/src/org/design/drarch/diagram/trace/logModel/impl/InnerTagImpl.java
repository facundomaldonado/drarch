...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>InnerTag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class InnerTagImpl extends EObjectImpl implements InnerTag {
	...
	public EMap getTags() {
		if (tags == null) {
			tags = new EcoreEMap(LogModelPackage.eINSTANCE.getEStringToLogNodeMapEntry(), EStringToLogNodeMapEntryImpl.class, this, LogModelPackage.INNERTAG__TAGS);
		}
		return tags;
	}
