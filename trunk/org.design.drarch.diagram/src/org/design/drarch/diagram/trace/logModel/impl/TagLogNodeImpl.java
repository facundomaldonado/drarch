 ...
 * <copyright> </copyright>
 * 
 * $Id: TagLogNodeImpl.java,v 1.1 2006/10/07 19:05:16 nfrontini Exp $
 */
...
import org.design.drarch.diagram.trace.LogSearcher.NumberKeyComparator;
...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Tag Log Node</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.design.drarch.diagram.trace.logModel.impl.TagLogNodeImpl#getChildrens <em>Childrens</em>}</li>
 * <li>{@link org.design.drarch.diagram.trace.logModel.impl.TagLogNodeImpl#getTag <em>Tag</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TagLogNodeImpl extends LogNodeImpl implements TagLogNode {
  /**
   * The default value of the '{@link #getChildrens() <em>Childrens</em>}'
  ...
  public void setChildrens(LogNode[] newChildrens) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          LogModelPackage.TAG_LOG_NODE__CHILDRENS, oldChildrens, childrens));
  }
      ...
      if (tag != oldTag) {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE,
              LogModelPackage.TAG_LOG_NODE__TAG, oldTag, tag));
      }
    }
    return tag;
  }
  ...
  public boolean eIsSet(EStructuralFeature eFeature) {
    ...
    case LogModelPackage.TAG_LOG_NODE__CHILDRENS:
      return CHILDRENS_EDEFAULT == null ? childrens != null
          : !CHILDRENS_EDEFAULT.equals(childrens);
    case LogModelPackage.TAG_LOG_NODE__TAG:
      return tag != null;
    }
