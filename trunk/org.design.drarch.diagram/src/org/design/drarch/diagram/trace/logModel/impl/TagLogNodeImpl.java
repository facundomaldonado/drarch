...
public class TagLogNodeImpl extends LogNodeImpl implements TagLogNode {
	...
	public void setChildrens(LogNode[] newChildrens) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogModelPackage.TAG_LOG_NODE__CHILDRENS, oldChildrens, childrens));
	}
	...
	public Tag getTag() {
		if (tag != null && tag.eIsProxy()) {
			...
			if (tag != oldTag) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, LogModelPackage.TAG_LOG_NODE__TAG, oldTag, tag));
			}
		}
		return tag;
	}
	...
	public void setTag(Tag newTag) {
		...
		tag = newTag;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LogModelPackage.TAG_LOG_NODE__TAG, oldTag, tag));
	}
