...
//		MappingmodelPackageImpl.init();
	...
	public EAttribute getEStringToLogNodeMapEntry_Key() {
		return (EAttribute)eStringToLogNodeMapEntryEClass.getEStructuralFeatures().get(0);
	}
	...
	public EReference getEStringToLogNodeMapEntry_Value() {
		return (EReference)eStringToLogNodeMapEntryEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEAttribute(eStringToLogNodeMapEntryEClass, ESTRING_TO_LOG_NODE_MAP_ENTRY__KEY);
		createEReference(eStringToLogNodeMapEntryEClass, ESTRING_TO_LOG_NODE_MAP_ENTRY__VALUE);
	...
	public void initializePackageContents() {
		...
		LogPackageImpl theLogPackage = (LogPackageImpl)EPackage.Registry.INSTANCE.getEPackage(LogPackage.eNS_URI);
		...
		initEClass(logNodeEClass, LogNode.class, "LogNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getLogNode_Name(), ecorePackage.getEString(), "name", null, 0, 1, LogNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(materializationEClass, InnerTag.class, "InnerTag", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMaterialization_Tags(), this.getEStringToLogNodeMapEntry(), null, "tags", null, 0, -1, InnerTag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(propertyLogNodeEClass, PropertyLogNode.class, "PropertyLogNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPropertyLogNode_Value(), ecorePackage.getEString(), "value", null, 0, 1, PropertyLogNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(tagLogNodeEClass, TagLogNode.class, "TagLogNode", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTagLogNode_Childrens(), this.getLogNodeArray(), "childrens", null, 0, 1, TagLogNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTagLogNode_Tag(), theLogPackage.getTag(), null, "tag", null, 0, 1, TagLogNode.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(eStringToLogNodeMapEntryEClass, Map.Entry.class, "EStringToLogNodeMapEntry", !IS_ABSTRACT, !IS_INTERFACE, !IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEStringToLogNodeMapEntry_Key(), ecorePackage.getEString(), "key", null, 0, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEStringToLogNodeMapEntry_Value(), this.getLogNode(), null, "value", null, 0, 1, Map.Entry.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize data types
		initEDataType(logNodeArrayEDataType, LogNode[].class, "LogNodeArray", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
