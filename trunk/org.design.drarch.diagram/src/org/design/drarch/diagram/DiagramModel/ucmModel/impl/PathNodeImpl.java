...
public class PathNodeImpl extends EObjectImpl implements PathNode {
	...
	/**
	 * The default value of the '{@link #getResponsibilityName() <em>Responsibility Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * The cached value of the '{@link #getResponsibilityName() <em>Responsibility Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getResponsibilityName()
	 * @generated
		...
		if (path != null && path.eIsProxy()) {
			...
			if (path != oldPath) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UcmModelPackage.PATH_NODE__PATH, oldPath, path));
			}
		}
		return path;
	}
	...
	public NotificationChain basicSetPath(Path newPath, NotificationChain msgs) {
		...
		path = newPath;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, UcmModelPackage.PATH_NODE__PATH, oldPath, newPath);
	...
	public void setPath(Path newPath) {
		if (newPath != path) {
			...
			if (path != null)
				msgs = ((InternalEObject)path).eInverseRemove(this, UcmModelPackage.PATH__NODES, Path.class, msgs);
			if (newPath != null)
				msgs = ((InternalEObject)newPath).eInverseAdd(this, UcmModelPackage.PATH__NODES, Path.class, msgs);
			msgs = basicSetPath(newPath, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmModelPackage.PATH_NODE__PATH, newPath, newPath));
	}
	...
	public EList getPrevious() {
		if (previous == null) {
			previous = new EObjectWithInverseResolvingEList.ManyInverse(PathNode.class, this, UcmModelPackage.PATH_NODE__PREVIOUS, UcmModelPackage.PATH_NODE__NEXT);
		}
		return previous;
	}
	...
	public EList getNext() {
		if (next == null) {
			next = new EObjectWithInverseResolvingEList.ManyInverse(PathNode.class, this, UcmModelPackage.PATH_NODE__NEXT, UcmModelPackage.PATH_NODE__PREVIOUS);
		}
		return next;
	}
	...
	public void setResponsibilityName(String newResponsibilityName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UcmModelPackage.PATH_NODE__RESPONSIBILITY_NAME, oldResponsibilityName, responsibilityName));
	}
	...
	public boolean eIsSet(EStructuralFeature eFeature) {
		switch (eDerivedStructuralFeatureID(eFeature)) {
			...
			case UcmModelPackage.PATH_NODE__RESPONSIBILITY_NAME:
				return RESPONSIBILITY_NAME_EDEFAULT == null ? responsibilityName != null : !RESPONSIBILITY_NAME_EDEFAULT.equals(responsibilityName);
		}
