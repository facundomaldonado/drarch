...
public class UcmModelFactoryImpl extends EFactoryImpl implements UcmModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case UcmModelPackage.COMPONENT_ROLE: return createComponentRole();
			case UcmModelPackage.PATH: return createPath();
			case UcmModelPackage.PATH_NODE: return createPathNode();
			case UcmModelPackage.UCM_DIAGRAM: return createUCMDiagram();
			case UcmModelPackage.UCM_MODEL: return createUCMModel();
			default:
